#!/bin/bash
#
# Remote installer for dbus-victron-orion-tr on Venus OS
# 
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/TechBlueprints/dbus-victron-orion-tr/main/install.sh | bash
#   wget -qO- https://raw.githubusercontent.com/TechBlueprints/dbus-victron-orion-tr/main/install.sh | bash
#

set -e

REPO_URL="https://github.com/TechBlueprints/dbus-victron-orion-tr.git"
...
echo "========================================"
echo "Victron Orion-TR Service Installer"
echo "========================================"
echo ""
